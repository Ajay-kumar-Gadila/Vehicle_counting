...
from vehicle_count import from_static_image,realTime
...
def imageBrowse():
    ...
    if strs[1] in imgex:
        ...
        from_static_image(openDirectory)
    else:
        #print("Invalid file ext")
        cap = cv2.VideoCapture(openDirectory)
        realTime()
